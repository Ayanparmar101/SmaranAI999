...
const ScienceStudyPlannerContainer = () => {
  ...
  const handleChapterSelect = (chapterId: string) => {
    console.log('[ScienceStudyPlannerContainer] Chapter selected via dropdown:', chapterId);
    setSelectedChapter(chapterId);
  };

  const handleResetPDF = () => {
    console.log('[ScienceStudyPlannerContainer] Resetting PDF and selected chapter.');
    setSelectedChapter(""); 
  };
  ...
  const handleGenerateStudyPlan = async () => {
    console.log('[ScienceStudyPlannerContainer] handleGenerateStudyPlan called for chapter:', selectedChapter, 'book:', selectedBook);
  ...
  const saveStudyPlan = async () => {
    ...
    console.log('[ScienceStudyPlannerContainer] Saving study plan for user:', user.uid);
    try {
      ...
      if (success) {
        toast.success("Science study plan saved successfully!");
      } else {
  ...
  const loadSavedStudyPlan = (savedPlan: any) => {
    ...
    toast.success("Science study plan loaded successfully!");
  };
...
export default ScienceStudyPlannerContainer;
